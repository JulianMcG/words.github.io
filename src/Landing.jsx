            ...
            <AnimatePresence>
              {scrolled && (
                <motion.button
                  ...
                  className="btn-tactile-dark group px-5 py-2 text-[13px] font-semibold rounded-[var(--radius-lg)] bg-[var(--color-text-primary)] text-[var(--color-bg-primary)] hover:opacity-90 flex items-center gap-2"
                >
                  Start writing
      ...
      <section className="relative px-6 h-[100svh] flex flex-col items-center justify-center">
        ...
        <div className="relative max-w-4xl mx-auto w-full text-center">
          ...
          >
            <button
              onClick={() => navigate('/documents')}
              className="btn-tactile-accent group px-8 py-3.5 text-white rounded-[var(--radius-xl)] font-semibold text-[17px] flex items-center gap-2"
            >
              Start writing
      ...
      <section className="px-6 pt-8 pb-24 sm:pb-32">
        <Reveal>
          <div className="max-w-3xl mx-auto text-center">
            ...
            <button
              onClick={() => navigate('/documents')}
              className="btn-tactile-accent group px-10 py-4 text-white rounded-[var(--radius-xl)] font-semibold text-lg inline-flex items-center gap-2"
            >
              Open Words
              <ArrowRight size={18} className="group-hover:translate-x-1 transition-transform" />
            </button>
