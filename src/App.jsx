    ...
    <div className="flex h-screen bg-[var(--color-bg-primary)] text-[var(--color-text-primary)] font-sans selection:bg-[#E8572A33] overflow-hidden relative w-full">
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="relative">
            <button
              ...
              className={`words-context-menu p-1.5 rounded-md transition-colors ${shareMenuOpen ? 'bg-[var(--color-bg-hover-strong)] text-[var(--color-text-primary)]' : 'text-[var(--color-text-faint)] hover:bg-[var(--color-bg-hover-strong)] hover:text-[var(--color-text-primary)]'}`}
              title="Options"
            >
      ...
      >
        <button
          ...
          className="p-1.5 text-[var(--color-text-faint)] hover:bg-[var(--color-bg-hover-strong)] hover:text-[var(--color-text-primary)] rounded-md transition-colors"
        >
          <Menu size={20} />
        </button>
      </div>{" "}
            ...
            {userMenuOpen && user && (
              ...
              <div className="bg-[var(--color-bg-primary)] border border-[var(--color-border-primary)] rounded-lg shadow-xl z-[60] w-[220px] py-1 px-1">
                ...
                >
                  ...
                  <ChevronDown size={13} className={`transition-transform duration-200 text-[var(--color-text-faint)] ${trashViewOpen ? 'rotate-180' : ''}`} />
                </button>
                <AnimatePresence>
                  {trashViewOpen && (
                    <motion.div
